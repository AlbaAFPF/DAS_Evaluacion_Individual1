...
public class AdaptadorListView extends BaseAdapter {
    ...
    List<ItemListViewPers> listaPers;

    // Constructor de la clase AdaptadorListView
    public AdaptadorListView(Context contexto, List<ItemListViewPers> listaPers) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ItemListViewPers item = listaPers.get(i);

        if(view==null){
            // Se indica el xml con el layout para cada elemento
            view = inflater.inflate(R.layout.listview_personalizado, null);
        }
